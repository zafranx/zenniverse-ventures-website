...
export const FooterSection = (): JSX.Element => {
  ...
  const socialIcons = [
    {
      alt: "Facebook",
      href: "https://facebook.com/zeniverseventures",
      icon: (
        <svg
    ...
    {
      alt: "Twitter",
      href: "https://twitter.com/zeniverseventures",
      icon: (
        <svg
          className="w-4 h-4 md:w-5 md:h-5"
          fill="currentColor"
    ...
    {
      alt: "Instagram",
      href: "https://instagram.com/zeniverseventures",
      icon: (
        <svg
          className="w-4 h-4 md:w-5 md:h-5"
          fill="currentColor"
    ...
    {
      alt: "LinkedIn",
      href: "https://linkedin.com/company/zeniverse-ventures",
      icon: (
        <svg
          className="w-4 h-4 md:w-5 md:h-5"
          fill="currentColor"
            ...
            <div className="flex flex-col items-center lg:items-start gap-3 sm:gap-4 md:gap-5 lg:gap-[23px] w-full lg:w-[285px] text-center lg:text-left">
              ...
              <div className="relative">
                <Link to="/" className="block">
                  <img
                    className="w-[100px] h-[50px] sm:w-[120px] sm:h-[60px] md:w-[140px] md:h-[70px] lg:w-[152px] lg:h-[80px] object-contain drop-shadow-lg hover:scale-105 transition-transform duration-300"
