...
//   return (
//     <header className="flex items-center justify-between px-4 md:px-8 lg:px-16 xl:px-[120px] py-2 md:py-[7px] h-16 md:h-20 lg:h-[100px] w-full fixed top-0 left-0 bg-white shadow-[0px_4px_5px_#00000026] z-50">
//       <div className="flex items-center gap-4 md:gap-8 lg:gap-16 xl:gap-[120px]">
//         {/* <img className="w-auto h-12 md:h-16 lg:h-20" alt="Logo" src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=152&h=80&fit=crop" /> */}
//         <img
...
//       <Button className="px-3 md:px-6 py-2 md:py-3 bg-[#ededed] rounded-[5px] hover:bg-[#e0e0e0]">
//         <span className="font-bold text-sm md:text-base [font-family:'Poppins',Helvetica] text-[#255d86]">
//           Connect Now
//         </span>
//       </Button>
